...
In this lab we enhanced our home page using Recycle View which allowed us to add a list of hard coded task that the user can scroll up and down through it.
